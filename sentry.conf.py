...
AUTH_LDAP_SENTRY_ORGANIZATION_ROLE_TYPE = os.getenv('LDAP_DEFAULT_SENTRY_ROLETYPE', 'admin')
AUTH_LDAP_SENTRY_ORGANIZATION_GLOBAL_ACCESS = os.getenv('LDAP_SENTRY_GLOBAL_ACCESS', True)
